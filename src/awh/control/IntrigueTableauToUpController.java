...
import awh.move.MoveCardUpPile;
...
public class IntrigueTableauToUpController extends MouseAdapter {
	Intrigue game;
	ColumnView view;
	
	public IntrigueTableauToUpController(Intrigue g, ColumnView v) {
		this.game = g;
		this.view = v;
	}
	...
	public void MouseReleased(MouseEvent e) {
		...
		Move m = new MoveCardUpPile (fromColumn, theCard, toPile);
		if (m.doMove (game)) {
			// Successful move!  
